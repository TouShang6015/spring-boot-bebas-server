...
public class JobInvokeUtil {
     ...
     * @param sysJob 系统任务
     */
    public static void invokeMethod(SysJobModel sysJob) throws Exception {
    ...
    public static boolean isValidClassName(String invokeTarget) {
        return StringUtils.countMatches(invokeTarget, StringPool.DOT) > 1;
    }
    ...
    public static String getBeanName(String invokeTarget) {
        ...
        return StringUtils.substringBeforeLast(beanName, StringPool.DOT);
    }
    ...
    public static String getMethodName(String invokeTarget) {
        ...
        return StringUtils.substringAfterLast(methodName, StringPool.DOT);
    }
