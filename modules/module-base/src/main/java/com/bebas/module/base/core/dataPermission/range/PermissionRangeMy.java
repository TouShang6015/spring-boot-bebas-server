 ...
 */
@Service
public class PermissionRangeMy implements PerRangeStrategy {
    ...
    public String getRangeSign() {
        return PermissionRangeEnums.MY.name();
    }
    ...
    public void scopeFilter(JoinPoint joinPoint, LoginUser user, SysRoleModel role) {
        ...
        for (Object arg : joinPoint.getArgs()) {
            ...
            if (arg instanceof SysUserModel) {
                ((SysUserModel) arg).queryParamIn(Constants.MAIN_ID, String.valueOf(user.getUserId()));
            }
