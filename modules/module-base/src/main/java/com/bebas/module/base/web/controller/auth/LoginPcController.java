...
import static com.bebas.org.common.constants.MessageCode.System.SYSTEM_NOT_OPEN_REGISTER;
...
public class LoginPcController extends PcLoginWorker {
    ...
    public Result register(@RequestBody RegisterBodyVo param) {
        if (!this.mainVO.getRegisterOpen())
            return Result.fail(MessageUtils.message(SYSTEM_NOT_OPEN_REGISTER));
